...
class ResidentVerifyScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ResidentVerifyScreen> createState() =>
      _ResidentVerifyScreenState();
}
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (!verified) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(
                      color: AppColors.markerPay.withValues(alpha: 0.3)),
                ),
                child: const Column(
                  children: [
            ...
            const Spacer(),
            Center(
              child: Text('인증 정보는 화성주민 여부 확인 외 사용되지 않아요',
                  style: TextStyle(
                      fontSize: 11,
...
class _StepRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = done
        ? AppColors.markerPay
        : (pending ? Colors.grey.shade300 : AppColors.primary);
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
            ...
            children: [
              Text(title,
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.w700,
                      fontSize: 14,
                      color: pending ? Colors.grey : AppColors.textPrimary)),
