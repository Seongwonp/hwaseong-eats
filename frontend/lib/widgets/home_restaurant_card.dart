...
class HomeRestaurantCard extends ConsumerWidget {
  ...
  final List<String> leadingKeywords; // 카드 앞에 붙는 동적 키워드 (e.g. ['오늘의 추천'])

  const HomeRestaurantCard({
    super.key,
    required this.restaurant,
    this.leadingKeywords = const ['오늘의 추천'],
  });
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(Icons.restaurant, color: AppColors.primary.withValues(alpha: 0.3), size: 32),
            ),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 2),
                Text(_distanceText.isNotEmpty ? _distanceText : '-', style: const TextStyle(fontSize: 12, color: Color(0xFF999999))),
